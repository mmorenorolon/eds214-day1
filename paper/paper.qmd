...
# Results
The reproduced figure shows similar patterns to Schaefer et al. (2000), with clear post-hurricane disturbances in nutrient concentrations across Bisley streams.
```{r}
